...
function togglePreview(editor) {
    ...
    var mdContent = editor.options.previewRender(editor.value(), preview);

    preview.innerHTML = ''

    var previewWarp = document.createElement('div');
    previewWarp.className = 'editor-preview-warp'; 
    previewWarp.innerHTML = mdContent

    preview.appendChild(previewWarp)

    // preview.innerHTML = mdContent;
    ...
    for (i = 0; i < items.length; i++) {
        ...
        (function (item) {
            ...
            if (item.name === 'upload-image') {
                ...
                barWarp.appendChild(imageInput);
            }
        })(items[i]);
    }
